...
async function main() {
  ...
  await prisma.ticket.createMany({
    data: [
      ...
      },
      {
        ...
        description: "A documentação precisa ser atualizada com as novas funcionalidades.",
  ...
  await prisma.comment.createMany({
    data: [
      ...
      { ownerId: owners[1].id, ticketId: tickets[0].id, content: "Aguardando revisão." },
      ...
      { ownerId: owners[0].id, ticketId: tickets[3].id, content: "Atualização em andamento." },
      { ownerId: owners[3].id, ticketId: tickets[4].id, content: "Trabalhando na nova funcionalidade." },
      { ownerId: owners[4].id, ticketId: tickets[5].id, content: "Refatoração em progresso." },
    ],
  });
